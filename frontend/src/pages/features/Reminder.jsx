    ...
    <div className="min-h-[calc(100vh-7rem)] flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-green-100 to-blue-200 py-6 px-2 md:px-6 overflow-y-visible">
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-6 md:gap-10 items-stretch">
        ...
        <div className="md:w-4/5 w-full flex flex-col gap-6 md:gap-8 bg-white rounded-3xl shadow-2xl p-4 md:p-8 lg:p-14 border border-blue-100 text-center">
          <h1 className="text-2xl md:text-3xl font-extrabold text-blue-700 mb-2 text-center tracking-tight">Set Medicine Reminder</h1>
          <input
            value={medicine}
            onChange={(e) => setMedicine(e.target.value)}
            placeholder="Medicine name"
            className="border px-4 py-3 rounded-xl w-full mb-3 text-base md:text-lg shadow-sm"
          />
          <input
            value={time}
          ...
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-xl w-full font-bold text-base md:text-lg shadow"
          >
            Save Reminder
          </button>
        ...
        <div className="md:w-2/5 w-full flex flex-col items-center gap-4 md:gap-6 mt-6 md:mt-0">
          <div className="w-full bg-yellow-50 border-l-4 border-yellow-400 rounded-2xl p-4 md:p-5 shadow flex flex-col items-center gap-2 mb-2">
            ...
            <ol className="list-decimal list-inside text-yellow-900 text-xs md:text-sm space-y-1">
          ...
          <div className="w-full bg-white rounded-3xl shadow-xl border border-blue-100 overflow-hidden flex flex-col items-center">
            <img src={image} alt="Reminder" className="w-full h-40 md:h-56 object-cover rounded-t-3xl" />
          </div>
        </div>
      </div>
    </div>
